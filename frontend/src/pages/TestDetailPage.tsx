  ...
  return (
    <div>
      <div className="mb-1 flex items-center gap-3">
        <h1 className="break-all font-mono text-lg text-zinc-100">{test.node_id}</h1>
        ...
        <>
          ...
          <div className="space-y-3">
            {[...byFingerprint.entries()].map(([fingerprint, group]) => {
              ...
              return (
                <div key={fingerprint} className="rounded-lg border border-zinc-800 bg-zinc-900/40 p-4">
