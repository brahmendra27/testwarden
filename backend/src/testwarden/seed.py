...
Usage: python -m testwarden.seed
"""
import random
import uuid
...
from testwarden.schemas.ingest import AttemptIn, ResultEnvelope, RunCreate
from testwarden.services.ingestion import get_or_create_run, ingest_results
...
def main() -> None:
    ...
    with SessionLocal() as db:
        if db.scalar(select(Project).where(Project.slug == "demo-web")) is not None:
            print("Project 'demo-web' already seeded - delete data/testwarden.db to reseed.")
            return
